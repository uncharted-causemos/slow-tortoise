...
#   WM_S3_DEST_URL - Custom aws s3 url. If this is provided, default aws connection with AWS_ACCESS_KEY_ID and AWS_SECRET_ACCESS_KEY is ignored 
#   WM_S3_DEST_KEY - Acess Key for the custom aws s3 url
#   WM_S3_DEST_SECRET - Secret for the custom aws s3 url 
